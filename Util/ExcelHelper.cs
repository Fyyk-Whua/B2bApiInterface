...
namespace Util
{
    public class ExcelHelper
    {
        ...
        #region ExportToExcelFalse
        /// <summary>
        /// ExportToExcelFalse
        /// </summary>
        /// <param name="dataGridView"></param>
        public void ExportToExcelFalse(DataGridView dataGridView)
        {
            exportToExcelFalse(dataGridView);
        }
        private void exportToExcelFalse(DataGridView dataGridView)
        {
            ...
            s.FilterIndex = 1;
            s.FileName = Util.NewGuid.GuidToLongID().ToString();
